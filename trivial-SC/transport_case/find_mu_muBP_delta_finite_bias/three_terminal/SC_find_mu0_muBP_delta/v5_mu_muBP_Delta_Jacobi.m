function [F, J] = v5_mu_muBP_Delta_Jacobi(Sample, x)
mu0 = x(1);
mu_BP = x(2);%A_mu_exBP
delta = x(3);
Ui = Sample.Ui;
...
int=integral(@(EF) v5_current_diffDelta_jacobi(Sample, EF, mu0, mu_BP, delta),-inf,inf,"ArrayValued",true,'RelTol',gap_RelTol,'AbsTol',gap_AbsTol);
