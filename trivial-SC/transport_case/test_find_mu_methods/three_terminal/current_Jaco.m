function [total_I, J] = current_Jaco(mu0)
Sample = parameter();
...
% J=J1+J_iU2+J_iD2;
J2_1 = -sum(sum( [TT_Ue(1,:);TT_Uh(2,:);TT_De(3,:);TT_Dh(4,:);TT_BPe(5,:);TT_BPh(6,:)] ));
J2_2 = sum(sum( kron(ones(3),[1,-1;-1,1]).*[TT_Ue(:,1),TT_Uh(:,2),TT_De(:,3),TT_Dh(:,4),TT_BPe(:,5),TT_BPh(:,6)] ));
J2 = J2_1+J2_2;
J = J1+J2;
%%
