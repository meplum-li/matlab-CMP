function [total_I, Dmu, Ddelta] = current_Dmu_Ddelta(mu0)
Sample = parameter();
...
%         TT = zeros(6,6);%不同能量对应的透射系数
        ...
        i_vec(7) = sum( (fUe - [fUe,fUh, fDe, fDh, fBPe, fBPh]) *TT_partial_delta(:,1) ) ...
            -sum( (fUh - [fUe, fUh, fDe, fDh, fBPe, fBPh]) *TT_partial_delta(:,2) );
        i_vec(8) = sum( (fDe - [fUe, fUh, fDe, fDh, fBPe, fBPh]) *TT_partial_delta(:,3) ) ...
            -sum( (fDh - [fUe, fUh, fDe, fDh, fBPe, fBPh]) *TT_partial_delta(:,4) );
        i_vec(9) = sum( (fBPe - [fUe, fUh, fDe, fDh, fBPe, fBPh]) *TT_partial_delta(:,5) ) ...
            -sum( (fBPh - [fUe, fUh, fDe, fDh, fBPe, fBPh]) *TT_partial_delta(:,6) );%BP
    end
%%
